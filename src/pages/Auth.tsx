...
import { ArrowRight, Gift, Loader2, Mail, UserX } from "lucide-react";
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="flex min-h-screen items-center justify-center px-4 py-10">
        <Card className="min-w-[350px] max-w-md border shadow-md">
          {step === "signIn" ? (
            <>
              <CardHeader className="text-center">
                <Link to="/" className="mx-auto grid h-16 w-16 place-items-center rounded-2xl gradient-brand font-display text-2xl font-black text-primary-foreground shadow-lg shadow-primary/20">
                  H
                </Link>
                <CardTitle className="mt-3 text-xl">Get Started</CardTitle>
              ...
              <form onSubmit={handleEmailSubmit}>
                <CardContent>
                  ...
                  <div className="relative mt-4">
                    <Gift className="absolute left-3 top-3 h-4 w-4 text-gold" />
                    <Input
                      value={referral}
